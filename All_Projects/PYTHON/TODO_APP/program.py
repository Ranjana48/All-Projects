...
def add():
  ...
  def addTask():
    ...
    try:
      ...
      tkmsgbox.showinfo(title = "info", message = "Task Created")
      e1.delete(0,tk.END)
      e2.delete(0,tk.END)
      e3.delete(0,tk.END)
      cn.commit()
      ...
      tkmsgbox.showerror(title="error", message = " Error in Creating Task")
      def close():
        awin.destroy()
...
def view():
  ...
  for row in rows:
      ...
      t1.pack(side=tk.TOP, fill=tk.BOTH)
...
def delete():
   ...
   def deletetask():
     ...
     if k>0:
      ...
      tkmsgbox.showerror(tittle="error",message="invalid taskid")
      def close():
        dwin.destroy()
...
def update():
    ...
    def updatetask():
      ...
      k = c.rowcount
      if k>0:
       tkmsgbox.showinfo(title = "info", message = " Task Updated")
       cn.commit()
      else:
